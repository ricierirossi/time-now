<template>
  <div>
    ...
    <div>
      <div v-if="socialNetworks && socialNetworks[0]">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div v-if="socialNetworks && socialNetworks[1]">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div v-if="socialNetworks && socialNetworks[2]">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div v-if="socialNetworks && socialNetworks[3]">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
